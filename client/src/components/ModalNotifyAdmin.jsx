            ...
            <div key={index} className="modal_notify_content">
              ...
              <div className="modal_notify_body">
                ...
                <div className="modal_notify_sub">
                  ...
                  <Link
                    to={`/admin/detail-report/${item.productId?._id}/${item._id}/${item.userAvatar}/${item.userName}/${item.userId}
              ...
              <div key={index} className="modal_notify_content">
                ...
                <div className="modal_notify_body">
                  <div className="modal_notify_text">
                    ...
                    <span className="text_bold">{item.productId?.title}</span>{" "}
                  ...
                  <div className="modal_notify_sub">
                    ...
                    <Link
                      to={`/admin/detail-report/${item.productId?._id}/${item._id}`}
                      className="modal_notify_btn"
                    >
                      Xem chi tiết
                    </Link>
